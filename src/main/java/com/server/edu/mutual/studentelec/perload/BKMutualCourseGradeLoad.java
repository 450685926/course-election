...
public class BKMutualCourseGradeLoad extends MutualDataProLoad<ElecContextMutualBk>
{
     ...
     * @see [类、类#方法、类#成员]
     */
    private void loadScoreTemp(ElecContextMutualBk context, StudentInfoCache studentInfo,
...
//    	dto.setCalendarId(context.getCalendarId());
        ...
        if (CollectionUtil.isNotEmpty(stuScore))
        {
            ...
            Consumer<CompletedCourse> consumer = new Consumer<CompletedCourse>()
            {
                ...
                {
                  //课程安排查询
                    List<ClassTimeUnit> times = BKMutualCourseGradeLoad.this.concatTime(collect, t.getCourse());
