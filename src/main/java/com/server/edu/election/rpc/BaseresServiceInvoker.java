...
public class BaseresServiceInvoker
{
    ...
    public static RestResult<List<Classroom>> queryAllClassRoom(List<String> roomIds){
    	@SuppressWarnings("unchecked")
    	RestResult<List<Classroom>> classrooms= ServicePathEnum.BASESERVICE.getForObject("/schoolCalendar/queryAllClassRoom?roomIds={roomIds}", RestResult.class, roomIds);
    	return classrooms;
    }
