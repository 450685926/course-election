...
public interface ElecRoundCourseDao  extends Mapper<ElectionRoundsCour>,MySqlMapper<ElectionRoundsCour>
{
	...
	List<CourseOpenDto> selectYjsTeachingClassByCalendarId(
			@Param("calendarId") Long calendarId);
	 ...
	 * @return
	 */
	List<CourseOpenDto> selectCorseRefTeachClassGraduteByRoundId(@Param("roundId") Long roundId, @Param("calendarId") Long calendarId, @Param("manageDptId") String manageDptId);
	 ...
	 * @return
	 */
	List<CourseOpenDto> selectCourseInfoByCalendarIdForMutual(@Param("calendarId") Long calendarId, @Param("projectId") String projectId);
